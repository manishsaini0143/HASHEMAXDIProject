  ...
  return (
    ...
    {/* <Text style={{color:'#BDBDBD'}}>Data Range</Text> */}
      ...
      <ScrollView horizontal style={{ flexDirection: 'row', backgroundColor: '#1E293B' }}>
        ...
        <Text style={{ color: '#FFFFFF', fontSize: 25, fontWeight: 'bold', margin: 10 }}>My Current Gool</Text>
        ...
        <View style={{ margin: 10, left: 10 }}>
          <Text style={{ color: '#FFFFFF', fontSize: 18, fontWeight: 'bold', }}>5 dollars a day </Text>
          <Text style={{ color: '#FFFFFF', fontSize: 18, fontWeight: 'bold', width: 300 }}>I am dedicating in memory of my
            mother.</Text>
        ...
        <View style={{ borderWidth: 2, borderColor: '#64748B', margin: 10, borderRadius: 10 }}>
