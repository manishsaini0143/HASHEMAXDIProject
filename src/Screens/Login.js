        ...
        <KeyboardAvoidingView  style={{ backgroundColor: '#0F172A', flex: 1 }}>
            ...
            <ScrollView style={{alignSelf:'center'}}>
                ...
                <View style={{ margin: 10, borderRadius: 10, backgroundColor: '#1E293B', width: '95%', flexDirection: 'row' }} >
                    ...
                    <TextInput style={{ color: '#FFFFFF', width: '70%', fontSize: 20, }}  onChangeText={(txt)=>{setlogPassword(txt)}} keyboardType='Password-type' placeholder='Password' 
                    placeholderTextColor='#FFFFFF' secureTextEntry={true}/>
                </View>
            <TouchableOpacity><Text style={{ color: '#FFFFFF', fontSize: 18, position: 'relative', left: 130, margin: 10 }}>Forgot your Password ?</Text></TouchableOpacity>
