    ...
    return (
        <View style={{ backgroundColor: '#0F172A', flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', padding: 15, marginTop: 20 }}>
                ...
                <Text style={{ color: '#FFFFFF', fontSize: 24, fontFamily: 'DMSans-Bold' }}>Forgot Password </Text>
            </View>
            ...
            <TouchableOpacity style={{ backgroundColor: '#1E293B', width: 340, height: 46, justifyContent: 'center', alignSelf: 'center', borderRadius: 15, top: 30 }}>
